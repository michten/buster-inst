...
x11_pkg="$x11_pkg kwin-x11 kwin-addons kde-l10n-pl"
x11_pkg="$x11_pkg fonts-hack-ttf fonts-noto fonts-noto-mono kde-config-gtk-style kde-config-gtk-style-preview kde-config-screenlocker kde-config-sddm khotkeys kde-config-tablet kinfocenter kio-extras kmenuedit kscreen kwrited libpam-kwallet5 powerdevil sni-qt systemsettings kwalletmanager"
...
#x11_pkg="$x11_pkg libreoffice-writer libreoffice-calc libreoffice-impress libreoffice-draw libreoffice-math libreoffice-kde libreoffice-style-breeze libreoffice-l10n-pl" 
...
x11_pkg="$x11_pkg gimp gimp-data-extras gimp-gutenprint gimp-lensfun gimp-plugin-registry gimp-texturize gimp-ufraw gtkam-gimp" 
